...
app.use(cors({
    origin: ["https://ai-assistant-lyart-delta.vercel.app", "https://api-ai-1-lz3k.onrender.com"],
    credentials: true,
...
app.post('/chatbot', verifyUser, async (req, res) => {
    try {
        ...
        const promptWithFormatting = aiInput + 
...
function categorizeQuery(query) {
    ...
    const careerKeywords = ['career', 'job', 'resume', 'interview', 'work', 'profession', 
                           'skill', 'project', 'programming', 'coding', 'development'];
